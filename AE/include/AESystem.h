...
/**
* @brief Prints to the console that was created by the Alpha Engine. Works
* similarly to "printf"
*
* @detail Use only if the Alpha Engine created the console (Check the
* "AESysInit" function).
*
* @param[in] Format C string that contains the text to be written.
*/
AE_API void AESysPrintf(const char *Format, ...);
