...
#define MyAppName "DigitalPenguins"
#define MyAppVersion "1.0"
#define MyAppPublisher "DigitalPenguins"
#define MyAppURL "http://www.digipen.edu/"
#define MyAppExeName "DigitalPenguins.exe"
...
AppId={{C2845014-03B5-48CC-A8C8-FDF767ACCC9E}       
AppName={#MyAppName}
...
[Icons]
IconFilename: "{app}\Icon.ico"; Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; 
IconFilename: "{app}\Icon.ico"; Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"; 
IconFilename: "{app}\Icon.ico"; Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; 
IconFilename: "{app}\Icon.ico"; Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; 
